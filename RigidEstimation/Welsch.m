function [Bfit,R,t,W]=Welsch(A,B,u,w)
...
% in magtlab robust regression toolbox and (FSAD) toolbox, they all use median(E)/.6745 
% instead of median(abs(E-median(E)))/.6745. We tested both scale estimates, and found 
% that median(E)/.6745 achieves better results than  s=median(abs(E-median(E)))/.6745;  

s=median(E)/.6745;
% s=median(abs(E-median(E)))/.6745;
E=E/s;
